...
<head>
  ...
  <meta content="assets\img\AutiCodes2.png" name="og:image">
  <meta content="Kelvin de Reus" name="og:title">
  <meta content="assets\img\AutiCodes2.png" name="twitter:image">
...
<main class="main">
  <section class="hero section light-background" id="hero">
    <img alt="" src="assets/img/bgnew.png">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-9">
          ...
          <p class="text-white"><span class="typed"
                                      data-typed-items="Change code, not the world. But later, change the world with that code."></span><span
                  aria-hidden="true" class="typed-cursor typed-cursor--blink"></span></p>
          <div class="social-links">
            <a class="text-white" href="https://github.com/AutiCodes" target="_blank"><i
                    class="bi bi-github"></i></a>
            <a class="text-white" href="https://www.youtube.com/@AutiCodes" target="_blank"><i
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>https://auticodes.nl</span>
                </li>
            ...
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>contact@auticodes.nl</span>
                </li>
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="resume-item pb-0">
            ...
            <ul>
              <li><a href="">
                <div class="social-links">
                  <a class="text-white" href="https://github.com/AutiCodes/AllDayBot"
                     target="_blank">
                    <i class="bi bi-github">
                      Github
                    </i>
